...
describe("console-logger", () => {
  ...
  test("support for literals", () => {
    ...
    expect(result).toBeTruthy();
    expect(result).toEqual([
      "%clevel-format#%cThis is a literal#%cmessage-format",
      "level-style",
      "",
      "message-style",
      1,
  ...
  test("formats logs", () => {
    ...
    expect(result).toBeTruthy();
    expect(result).toEqual([
      "%clevel-format#%cmessage-format#%cnamespace-format#%ctime-format#%cuptime-format",
      "level-style",
      "message-style",
      "namespace-style",
      "time-style",
  ...
  test("Style gets reset", () => {
    ...
    expect(result).toBeTruthy();
    expect(result).toEqual([
      "%clevel-format#%cmessage-format#namespace-format#%ctime-format#%cuptime-format",
      "level-style",
      "",
      "time-style",
      "",
