...
import { createLogFor, LogEvent, onLogEvent, customizeDefaultLogConfig, LogLevel, LoggerConfig } from './console-logger';
...
describe("console-logger", () => {
    test("generates events", () => {
        ...
        const logger = createLogFor("banana");
        logger("test");
    ...
    test("filters events at the individual logger level via constructor", () => {
        ...
        const logger = createLogFor("banana", { logThreshold: LogLevel.warn });
        logger("test1");
        logger.warn("test2");
    ...
    test("formats logs", () => {
        ...
        const logger = createLogFor("banana", testConfig);
